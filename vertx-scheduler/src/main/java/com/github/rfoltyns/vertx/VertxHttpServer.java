...
public class VertxHttpServer extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        router.post("/schedule").handler(request -> {
                ...
                ScheduleRequest scheduleRequest = Json.decodeValue(request.getBody(), ScheduleRequest.class);
                vertx.eventBus().send(scheduleRequest.getType(), JsonUtils.encodeToBuffer(scheduleRequest));
